    ...
    export class CubismMotion extends ACubismMotion
    {
        ...
        */
        ...
        public parse(motionJson: ArrayBuffer, size: number): void
        {
            ...
            {
                let cubismMotionCurve = new CubismMotionCurve()
                ...
                {
                    let cubismMotionSegment = new CubismMotionSegment()
                    if (segmentPosition == 0)
                    {
                        let cubismMotionPoint = new CubismMotionPoint()
            ...
            {
                let cubismMotionEvent = new CubismMotionEvent()
